...
INSERT INTO genero (genero) VALUES ('Ação'), ('Animação'), ('Aventura'), ('Cinema de arte'), ('Chanchada'), ('Cinema catástrofe'), ('Comédia'), ('Comédia romântica'), ('Comédia dramática'), ('Comédia de ação'), ('Dança'), ('Documentário'), ('Drama'), ('Espionagem'), ('Faroeste'), ('Fantasia científica'), ('Ficção científica'), ('Filmes de guerra'), ('Musical'), ('Filme policial'), ('Romance'), ('Seriado'), ('Suspense'), ('Terror');


INSERT INTO `pais` (`id_pais`, `pais`, `paisName`) VALUES
